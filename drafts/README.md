...
Skill đang viết dở. Thư mục này **nằm ngoài plugin `sonny`** nên Claude không nạp gì ở đây — viết
dở bao nhiêu cũng không tốn context và không tự kích hoạt nhầm.

Một draft chỉ được chuyển sang `sonny/skills/` khi đủ **cả ba**:
...
Dùng `mattpocock-skills:writing-for-agents` khi viết; ba điều trên là cổng cuối, không phải hướng
dẫn viết.
